  ...
  return (
    <div className="home">
      ...
      <footer className="home-footer">
        ...
        <a className="apk-download-btn" href="https://github.com/Mahendarmax/Believer-of-Almighty/releases/download/V1/Holy-Quran.apk" target="_blank" rel="noopener noreferrer">
